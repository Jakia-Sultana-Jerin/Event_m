...
urlpatterns = [
    ...
    path('packages/caterers/caterers-details/kabir', views.kabir_caterers_details, name='kabir_caterers_details'),
    path('packages/caterers/caterers-details/alpha', views.alpha_caterers_details, name='alpha_caterers_details'),
    path('packages/caterers/caterers-details/desh', views.desh_caterers_details, name='desh_caterers_details'),
